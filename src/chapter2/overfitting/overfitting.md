...
![IMAGE: Figure 11. This figure contains about 60 dots, half of which are healthy trees and the other half sick trees. The healthy trees are mainly in the northeast quadrant, though a few healthy trees sneak into the northwest quadrants. The sick trees are mainly in the southeast quadrant, but a few of the sick trees spill into other quadrants.](/static/chapter2/overfitting/overfitting/TreesTrainingSet.svg)
...
![IMAGE: Figure 12. The same arrangement of healthy and sick trees as in Figure 11. However, a model of complex geometric shapes separates nearly all of the healthy trees from the sick trees.](/static/chapter2/overfitting/overfitting/TreesTrainingSetComplexModel.svg)
...
![IMAGE: Figure 13. A new batch of healthy and sick trees overlaid on the model shown in Figure 12. The model miscategorizes many of the trees.](/static/chapter2/overfitting/overfitting/TreesTestSetComplexModel.svg)
...
![IMAGE: Figure 14. Cartesian plot.](/static/chapter2/overfitting/overfitting/underfit_fit_overfit.svg)
...
![IMAGE: Figure 15. The loss function for the training set gradually declines. The loss function for the validation set also declines, but then it starts to rise after a certain number of iterations.](/static/chapter2/overfitting/overfitting/RegularizationTwoLossFunctions.png)
...
![IMAGE: A horizontal bar divided into three pieces.](/static/chapter2/overfitting/overfitting/PartitionThreeSets.png)
